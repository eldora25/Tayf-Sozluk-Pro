...
class _QuizScreenState extends State<QuizScreen> {
  ...
  void _handleOptionTap(String option) async {
    ...
    if (option == _currentWord.meanings.first) {
      ...
      await flutterTts.speak("Correct"); // YENİ: Doğru seslendirmesi
      
      setState(() {
        _correctAnswers++;
        _currentWord.correctCount++; // HATA DÜZELTİLDİ: quizCorrectCount yerine doğru değişken
      ...
      await flutterTts.setLanguage("en-US");
      await flutterTts.speak("Wrong"); // YENİ: Yanlış seslendirmesi

...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  bool _isLowPowerMode = false; // YENİ: Düşük Güç (Performans) Modu State'i
                ...
                ListTile(
                  ...
                  onTap: () { 
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (context) => SettingsScreen(
                      currentGoal: dailyGoal, currentThreshold: quizThreshold, currentQuestionCount: quizQuestionCount, currentThemeIndex: widget.themeIndex, selectedLibrary: selectedLibrary, selectedLevel: selectedLevel, isGlobalSrsEnabled: _globalSrs, 
